...
local node1 = keywordHandler:addKeyword({'promot', 'promote', 'promotion'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'I can promote you for 20000 gold coins. Do you want me to promote you?'})
